...
public class Continent {
    ...
    public static final Continent AFRICA = new Continent(new RectArea [] {
        new RectArea(270, 175, 350, 175, 270, 220, 350, 220),
        new RectArea(310, 210, 385, 210, 310, 290, 385, 290)
    });
    
    public static final Continent ASIA = new Continent(new RectArea [] {
